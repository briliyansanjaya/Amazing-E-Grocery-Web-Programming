...
<?php echo $__env->make('components.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="container d-flex justify-content-center pt-2 min-vh-100">
        <div class="marginbottom col-lg-6">
            ...
            <?php if($products->count() > 0): ?>
                ...
                <div class="card mb-3">
                    <div class="d-flex row-cols-lg-3">
                            <div class="col-lg-4">
                                <img src="<?php echo e(asset('storage/images/'.$product->products[0]->productphoto)); ?>" class="img-fluid rounded-start" alt="produk">
                            </div>
                            <div class="col-lg-8">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="card-title fw-bold m-0 p-0"><?php echo e(Str::limit($product->products[0]->productname, 25)); ?></h5>
                                        <div class="d-flex">
            ...
            <?php else: ?>
                <div class="text-center mt-4 fw-bold">
                    ...
                    <a href="/home"><button type="button" class="btn btn-outline-success mt-1">Shop More Product</button></a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\brili\Downloads\AmazingE-Grocery\resources\views/user/cart.blade.php ENDPATH**/ ?>