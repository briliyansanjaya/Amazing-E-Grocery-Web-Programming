            ...
            <div class="m-3">
                <div class="row mx-auto">
                    <div class="border border-secondary col-md-4 p-0 m-0">
                        ...
                        <img src="<?php echo e(asset('storage/images/'.$product->productphoto)); ?>" class="img-fluid" alt="product">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h3 class="card-title fw-bold"><?php echo e($product->productname); ?></h3>
                            <div class="d-flex justify-content-between">
                                <p class="card-text"><small class="text-muted">Detail</small></p>
                                <p class="col-lg-10 card-text"><?php echo e($product->productdetail); ?></p>
                            </div>
                            <br>
                            <div class="d-flex justify-content-between">
                                <p class="card-text"><small class="text-muted">Price</small></p>
                                <p class="col-lg-10 card-text">IDR <?php echo e($product->productprice); ?></p>
                            </div>
                            <div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\brili\Downloads\AmazingE-Grocery\resources\views/pages/productdetail.blade.php ENDPATH**/ ?>