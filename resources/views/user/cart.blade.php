            ...
            @if($products->count() > 0)
                ...
                <div class="card mb-3">
                    <div class="d-flex row-cols-lg-3">
                            <div class="col-lg-4">
                                <img src="{{ asset('storage/images/'.$product->products[0]->productphoto) }}" class="img-fluid rounded-start" alt="produk">
                            </div>
                            <div class="col-lg-8">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <h5 class="card-title fw-bold m-0 p-0">{{ Str::limit($product->products[0]->productname, 25) }}</h5>
                                        <div class="d-flex">
